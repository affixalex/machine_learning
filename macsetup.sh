...
/opt/pkg/bin/pkgin in gcc5-5.3.0nb1 qt4-4.8.7 python35-3.5.1nb2 py35-pip-7.1.2 zeromq-4.1.4 py35-qt4-4.11.4nb2 py35-sqlite3-3.5.1nb6 py35-py2app-0.9
...
/opt/pkg/bin/pip install sphinx jupyter pandas scipy sklearn matplotlib networkx deap django flask feather-format tox
...
echo "PATH=/opt/pkg/bin:/opt/pkg/sbin:$PATH:/opt/pkg/qt4/bin" >> ~/.bashrc
echo "PATH=/opt/pkg/bin:/opt/pkg/sbin:$PATH:/opt/pkg/qt4/bin" >> ~/.zshrc
echo "Done."